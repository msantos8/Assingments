...
plot1 <- ggplot(mytips, aes(x = total_bill, y = tip)) +
  geom_point()

ggplot(mytips, aes(x = total_bill, y = tip)) +
  geom_point() +
  xlab("Total Bill") +
  ylab("Tip Amount")
...
ggplot(mytips, aes(x = total_bill, y = tip)) +
  geom_point() +
  scale_x_continuous(name = "Total Bill") +
  scale_y_continuous(name = "Tip Amount")
...
```{r}
library(scales)
summary(mytips$total_bill)

ggplot(mytips, aes(x = total_bill, y = tip)) +
  geom_point() +
  scale_x_log10(name = "Total Bill") +
  scale_y_continuous(name = "Tip Amount")

ggplot(mytips, aes(x = total_bill, y = tip)) +
  geom_point() +
  scale_x_log10(name = "Total Bill", breaks = seq(0, 60, 5), labels = dollar) +
  scale_y_continuous(name = "Tip Amount", breaks = seq(0, 10, 2), labels = dollar)
...
ggplot(mytips, aes(x = total_bill, y = tip, color = sex)) +
  geom_point() +
  scale_x_log10(name = "Total Bill", breaks = seq(0, 60, 5), labels = dollar) +
  scale_y_continuous(name = "Tip Amount", breaks = seq(0, 10, 2), labels = dollar) +
...
ggplot(mytips, aes(x = total_bill, y = tip, color = sex)) +
  ...
  scale_y_continuous(name = "Tip Amount", breaks = seq(0, 10, 2), labels = dollar) +
  geom_smooth(method = lm) +
  scale_fill_continuous(name = "Gender") +
